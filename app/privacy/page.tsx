...
const sections = [
  {
    ...
    body:
      'CoreLoop collects the information needed to run the marketplace, including account details, campaign and application content, payout-related information, and basic usage data.',
  },
  {
    title: 'How we use it',
    body:
  ...
  },
  {
    title: 'Contact',
    body:
      'Questions about privacy can be sent to support@coreloop.com.',
  },
]
...
export default function PrivacyPage() {
  return (
    <PublicPageShell
      eyebrow="Privacy"
      title="Privacy policy for the CoreLoop marketplace."
      description="This page explains the basic information CoreLoop collects, why it is collected, and how it is used to operate creator and brand workflows."
    >
